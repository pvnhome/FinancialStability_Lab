...
WEIGHT_SCHEME = CONFIG.main_configs.get('WEIGHT_SCHEME')
...
print('starting to read fitered data for {} settle date'.format(SETTLE_DATE))  

###Creating sample
filtered_data = creating_sample('2017-08-14', 
                                clean_data, 
                                min_n_deal=MIN_N_DEAL, 
